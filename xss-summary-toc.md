-   [2.1. 无过滤的基本 XSS 测试](#无过滤的基本-xss-测试)
...
-   [2-46 stylesheet 样式表引入 (chrome
    测试无效)](#stylesheet-样式表引入-chrome-测试无效)
...
### 2-54 STYLE 标签（仅旧版本 Netscape 可用）
...
US-ASCII 编码（由 Kurt Huwig 发现）。它使用了畸形的 7 位 ASCII
编码来代替 8 位。这 个 XSS
